...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-0pky" colspan="2"><a href="llull.html"><span style="font-weight:normal">Ramon LLull prize</span></a> talk: {200} </td>
  </tr>
  <tr>
...
<tbody>
  ...
  <tr>
    <td class="tg-btxf"><span style="font-weight:normal">12:00 - 12:20</span></td>
    <td class="tg-btxf" colspan="2"><span style="font-weight:normal">Short break</span></td>
  </tr>
  <tr>
    <td class="tg-0pky"></td>
...
```{ojs}
//| echo: false
datar=dataf.filter(d => d.type == "R").sort((a, b) => a.Apellidos.localeCompare(b.Apellidos))

html`${muestra_lista(datar)}`
