...
[![RED2024-153572-T<br> Red de Matemática Discreta y Algorítmica](img/logo_mda-net.svg)](https://dam-network.github.io)
:::
:::
...
::: {.column width="35%"}
::: {style="text-align:center;"}
[![Instituto de Matemáticas<br>Universidad de Granada](img/logo-IMAG.png)](https://imag.ugr.es)
:::
:::
